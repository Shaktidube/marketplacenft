...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {isSidebarOpen && (
        <div
          className="fixed inset-0 bg-black bg-opacity-70 z-40 md:hidden" // Only visible on mobile
        ...
        <nav className='flex-grow'>
          <ul>
            <li className='mb-5 group'>
              <NavLink to="/marketplace/mint" className={linkClasses} onClick={() => setIsSidebarOpen(false)}>
            ...
            <li className='mb-5 group'>
              <NavLink to="/marketplace/buy-sell" className={linkClasses} onClick={() => setIsSidebarOpen(false)}>
            ...
            <li className='mb-5 group'>
              <NavLink to="/marketplace/live-sell" className={linkClasses} onClick={() => setIsSidebarOpen(false)}>
                <svg className="w-7 h-7 mr-4 text-indigo-300 group-hover:text-blue-100 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                Live Sales
                <span className="absolute bottom-0 left-0 w-0 h-0.75 bg-indigo-400 transition-all duration-300 group-hover:w-full group-hover:scale-x-100 origin-left"></span>
              </NavLink>
            </li>
            <li className='mb-5 group'>
              <NavLink to="/marketplace/auction" className={linkClasses} onClick={() => setIsSidebarOpen(false)}>
